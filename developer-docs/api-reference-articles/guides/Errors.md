...
| 428 - Precondition required | Preconditions must be met for the request to be successful (for example, a required field wasn't passed, or the passed gift card is out of funds).
