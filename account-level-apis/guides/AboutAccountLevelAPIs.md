...
The APIs in this category require using the [admin access with API key strategy](https://dev.wix.com/docs/api-reference/articles/authentication/about-identities#api-key-admin).    
