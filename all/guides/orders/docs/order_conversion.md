...
| `totals.refund`                                             | Not available in eCommerce order object.                                  | Currently, this information is held in the Stores order object. Pass `order.id` to the [Stores Get Order](https://dev.wix.com/api/rest/wix-stores/orders/get-order) endpoint.
| `totals.giftCard`                                           | Not available in eCommerce order object.                                  | Currently, this information is held in the Stores order object. Pass `order.id` to the [Stores Get Order](https://dev.wix.com/api/rest/wix-stores/orders/get-order) endpoint.
| `billingInfo.paymentMethod`                                 | Not available in eCommerce order object.                                  | Currently, this information is held in the Stores order object. Pass `order.id` to the [Stores Get Order](https://dev.wix.com/api/rest/wix-stores/orders/get-order) endpoint.
| `billingInfo.paymentProviderTransactionId`                  | Not available in eCommerce order object.                                  | Currently, this information is held in the Stores order object. Pass `order.id` to the [Stores Get Order](https://dev.wix.com/api/rest/wix-stores/orders/get-order) endpoint.
| `billingInfo.paymentGatewayTransactionId`                   | Not available in eCommerce order object.                                  | Currently, this information is held in the Stores order object. Pass `order.id` to the [Stores Get Order](https://dev.wix.com/api/rest/wix-stores/orders/get-order) endpoint.
| `billingInfo.paidDate`                                      | Not available in eCommerce order object.                                  | Currently, this information is held in the Stores order object. Pass `order.id` to the [Stores Get Order](https://dev.wix.com/api/rest/wix-stores/orders/get-order) endpoint.
| `billingInfo.refundableByPaymentProvider`                   | Not available in eCommerce order object.                                  | Currently, this information is held in the Stores order object. Pass `order.id` to the [Stores Get Order](https://dev.wix.com/api/rest/wix-stores/orders/get-order) endpoint.
...
| `lineItems[i].options`                                      | `lineItems[i].descriptionLines`                                      | [Stores Catalog eCommerce Reference](https://bo.wix.com/wix-docs/rest/stores/stores-catalog/ecommerce-integration)
...
| `invoiceInfo`                                               | Not available in eCommerce order object.                                     | Currently, this information is held in the Stores order object. Pass `order.id` to the [Stores Get Order](https://dev.wix.com/api/rest/wix-stores/orders/get-order) endpoint.
...
| `refunds`                                                   | Not available in eCommerce order object.                                  | Currently, this information is held in the Stores order object. Pass `order.id` to the [Stores Get Order](https://dev.wix.com/api/rest/wix-stores/orders/get-order) endpoint.
